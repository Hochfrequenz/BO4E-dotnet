...
namespace BO4E.COM
{
    ...
    public class Preisstaffel : COM
    {
        ...
        [JsonProperty(PropertyName = "einheitspreis", Required = Required.Default)]
        [JsonPropertyName("einheitspreis")]
        [ProtoMember(3)]
        public decimal? Einheitspreis { get; set; }

        /// <summary>Unterer Wert, ab dem die Staffel gilt.</summary>
        [JsonProperty(PropertyName = "staffelgrenzeVon", Required = Required.Default)]
        ...
        [JsonProperty(PropertyName = "staffelgrenzeBis", Required = Required.Default)]
