...
public class Erreichbarkeit : COM
{
    ...
    [JsonProperty(PropertyName = "montagErreichbarkeit", Order = 3)]
    ...
    [JsonProperty(PropertyName = "dienstagErreichbarkeit", Order = 4)]
    ...
    [JsonProperty(PropertyName = "mittwochErreichbarkeit", Order = 5)]
    ...
    [JsonProperty(PropertyName = "donnerstagErreichbarkeit", Order = 6)]
    ...
    [JsonProperty(PropertyName = "freitagErreichbarkeit", Order = 7)]
    ...
    [JsonProperty(PropertyName = "mittagspause", Order = 8)]
