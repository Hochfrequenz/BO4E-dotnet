...
public enum KategorieTechnischeRessource
{
    ...
    [System.Text.Json.Serialization.JsonStringEnumMemberName("FAELLT_UNTER_14A")]
    FAELLT_UNTER_14A,

    /// <summary>ZG9: Technischen Ressource fällt nicht unter § 14a EnWG</summary>
    [EnumMember(Value = "FAELLT_NICHT_UNTER_14A")]
    [System.Text.Json.Serialization.JsonStringEnumMemberName("FAELLT_NICHT_UNTER_14A")]
