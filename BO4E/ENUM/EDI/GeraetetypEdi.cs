...
namespace BO4E.ENUM.EDI
{
    ...
    public enum GeraetetypEdi
    {
        ...
        [Mapping(Geraetetyp.DREHSTROMZAEHLER)] AHZ,
        ...
        [Mapping(Geraetetyp.MAXIMUMZAEHLER)] MAZ,
        ...
        [Mapping(Geraetetyp.BALGENGASZAEHLER)] BGZ,
        ...
        [Mapping(Geraetetyp.WIRBELGASZAEHLER)] WGZ,
