...
namespace BO4E.ENUM
{
    ...
    public enum FernsteuerbarkeitStatus
    {
        ...
        /// </summary>
        [ProtoEnum(Name = nameof(FernsteuerbarkeitStatus) + "_" + nameof(Z96_NICHT_FERNSTEUERBAR))]
        ...
        /// </summary>
        [ProtoEnum(Name = nameof(FernsteuerbarkeitStatus) + "_" + nameof(Z97_TECHNISCH_FERNSTEUERBAR))]
        ...
        /// </summary>
        [ProtoEnum(Name = nameof(FernsteuerbarkeitStatus) + "_" + nameof(Z98_LIEFERANT_FERNSTEUERBAR))]
