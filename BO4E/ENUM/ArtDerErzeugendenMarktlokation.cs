...
public enum ArtDerErzeugendenMarktlokation
{
    ...
    /// <remarks>Z33</remarks>
    [ProtoEnum(Name = nameof(ArtDerErzeugendenMarktlokation) + "_" + nameof(EEG_MALO_OHNE_DV_PFLICHT))]
    ...
    /// <remarks>Z34</remarks>
    [ProtoEnum(Name = nameof(ArtDerErzeugendenMarktlokation) + "_" + nameof(KWKG_MALO_OHNE_DV_PFLICHT))]
    ...
    /// <remarks>Z37</remarks>
    [ProtoEnum(Name = nameof(ArtDerErzeugendenMarktlokation) + "_" + nameof(EEG_MALO_MIT_DV_PFLICHT))]
    ...
    /// <remarks>Z46</remarks>
    [ProtoEnum(Name = nameof(ArtDerErzeugendenMarktlokation) + "_" + nameof(KWKG_MALO_MIT_DV_PFLICHT))]
