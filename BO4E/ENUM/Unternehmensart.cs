...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
    ...
    [ProtoEnum(Name = nameof(EEGVermarktungsform) + "_" + nameof(LIEFERANT))]
    LIEFERANT,

    [EnumMember(Value = "NETZBETREIBER")]
    [System.Text.Json.Serialization.JsonStringEnumMemberName("NETZBETREIBER")]
    [ProtoEnum(Name = nameof(EEGVermarktungsform) + "_" + nameof(NETZBETREIBER))]
    NETZBETREIBER,
    ...
    [ProtoEnum(Name = nameof(EEGVermarktungsform) + "_" + nameof(ÜBERTRAGUNGSNETZBETREIBER))]
    ÜBERTRAGUNGSNETZBETREIBER,

    [EnumMember(Value = "BILANZKOORDINATOR")]
    [System.Text.Json.Serialization.JsonStringEnumMemberName("BILANZKOORDINATOR")]
    [ProtoEnum(Name = nameof(EEGVermarktungsform) + "_" + nameof(BILANZKOORDINATOR))]
    BILANZKOORDINATOR,
    ...
    [ProtoEnum(Name = nameof(EEGVermarktungsform) + "_" + nameof(BILANZKREISVERANTWORTLICHER))]
    ...
    [ProtoEnum(Name = nameof(EEGVermarktungsform) + "_" + nameof(ENERGIESERVICEANBIETER))]
