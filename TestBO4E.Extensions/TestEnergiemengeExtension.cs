...
{
    internal static readonly TimeRange GERMAN_MARCH_2018 = new TimeRange(
        new DateTime(2018, 2, 28, 23, 0, 0, DateTimeKind.Utc),
        new DateTime(2018, 3, 31, 22, 0, 0, DateTimeKind.Utc)
    );

    internal static readonly TimeRange GERMAN_APRIL_2018 = new TimeRange(
        new DateTime(2018, 3, 31, 22, 0, 0, DateTimeKind.Utc),
        new DateTime(2018, 4, 30, 22, 0, 0, DateTimeKind.Utc)
    );

    internal static readonly TimeRange march2425 = new TimeRange(
        new DateTime(2018, 3, 23, 23, 0, 0, DateTimeKind.Utc),
