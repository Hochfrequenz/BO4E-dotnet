...
namespace BO4E.COM
{
    ...
    public class Preisgarantie : COM
    {
        ...
        /// <summary>Festlegung, auf welche Preisbestandteile die Garantie gewährt wird. Details <see cref="ENUM.Preisgarantietyp" /></summary>
        [JsonProperty(PropertyName = "preisgarantietyp", Required = Required.Always)]

        [System.Text.Json.Serialization.JsonPropertyName("preisgarantietyp")]
        [ProtoMember(4)]
        ...
        [System.Text.Json.Serialization.JsonPropertyName("zeitlicheGueltigkeit")]
        [ProtoMember(5)]
