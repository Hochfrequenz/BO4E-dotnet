...
namespace BO4E.COM
{
    ...
    public class Tarifeinschraenkung : COM
    {
        ...
        /// <summary>Voraussetzungen, die erfüllt sein müssen, damit dieser Tarif zur Anwendung kommen kann. Details <see cref="ENUM.Voraussetzungen" /></summary>
        ...
        [System.Text.Json.Serialization.JsonPropertyName("einschraenkungzaehler")]
        [ProtoMember(5)]
        ...
        [System.Text.Json.Serialization.JsonPropertyName("einschraenkungleistung")]
        [ProtoMember(6)]
