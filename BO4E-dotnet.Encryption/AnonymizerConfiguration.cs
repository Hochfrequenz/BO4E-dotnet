...
namespace BO4E.Encryption
{
    ...
    ///     <see cref="Anonymizer" /> class. For each possible <see cref="DataCategory" /> an <see cref="AnonymizerApproach" />
    ///     is
    ...
    public class AnonymizerConfiguration
    {
        ...
        /// <summary>
        ///     set of key in <see cref="BO4E.BO.BusinessObject.UserProperties" /> / <see cref="BO4E.COM.COM.UserProperties" />
        ...
        {
            return !ContainsNonKeepingOperations();
        }
    }
}